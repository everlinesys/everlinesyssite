      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        <div className="mb-10 flex items-center justify-between border-4 border-slate-900 bg-white p-4 shadow-[4px_4px_0_0_rgba(15,23,42,1)]">
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2 font-mono text-xs font-black uppercase text-slate-800">
          ...
          <Link to="/pricing" className="text-[10px] font-mono font-black uppercase tracking-wider text-slate-500 hover:text-slate-900 transition-colors hidden sm:block">
            // VIEW_PRICING_MATRIX
          </Link>
        </div>
        ...
        <div className="grid lg:grid-cols-12 gap-8 items-stretch">
          ...
          <div className="lg:col-span-8 bg-white border-4 border-slate-900 p-8 md:p-12 shadow-[10px_10px_0_0_rgba(15,23,42,1)] relative overflow-hidden flex flex-col justify-between">
            <div className="absolute top-0 right-0 bg-slate-900 text-emerald-400 font-mono text-[9px] font-black px-3 py-1 border-b-2 border-l-2 border-slate-900 tracking-widest">
              DEPLOYMENT_CORE_v4.2
            </div>

            <div>
              <div className="inline-flex items-center gap-2 px-3 py-0.5 bg-emerald-400 border-2 border-slate-900 text-slate-900 text-xs font-mono font-black uppercase tracking-wider shadow-[2px_2px_0_0_rgba(15,23,42,1)] -rotate-1 mb-8">
              ...
              <p className="text-base md:text-lg text-slate-700 font-bold max-w-2xl border-l-4 border-slate-900 pl-4 py-1 mb-8">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-8 border-t-4 border-slate-900">
              {[
                ...
                <div key={i} className="bg-[#f4f4f0] border-2 border-slate-900 p-3 shadow-[3px_3px_0_0_rgba(15,23,42,1)]">
                  <div className="flex items-center gap-1.5 text-slate-500 font-mono text-[9px] font-black uppercase tracking-wider mb-1">
                    {metric.icon} {metric.label}
                  </div>
                  <div className="text-lg font-mono font-black text-slate-900">{metric.val}</div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="lg:col-span-4 flex flex-col gap-8">
            ...
            <div className="bg-slate-900 text-white border-4 border-slate-900 p-8 shadow-[10px_10px_0_0_rgba(52,211,153,1)] relative flex-grow flex flex-col justify-between">
              <div>
                ...
                <h3 className="text-xl font-black uppercase tracking-tight mb-3">Initialize Architecture</h3>
            ...
            <div className="bg-white border-4 border-slate-900 p-6 shadow-[10px_10px_0_0_rgba(15,23,42,1)]">
              <div className="flex items-center gap-2 font-mono text-[10px] font-black text-slate-400 uppercase border-b-2 border-slate-900 pb-2 mb-4">
